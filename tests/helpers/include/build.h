...
constexpr auto STOCHASTIC_RND = ckernel::None;
...
// Buffer addresses and operands
constexpr Operand buffer_A(0x1A000, 128);
constexpr Operand buffer_B(0x1B000, 128);
constexpr Operand buffer_Res(0x1C000, 128);

// RT_DIM: Row tiles dimension
// // CT_DIM: Column tiles dimension
// // KT_DIM: K dimension (contraction dimension)
constexpr uint32_t RT_DIM = 1;
constexpr uint32_t CT_DIM = 1;
constexpr uint32_t KT_DIM = 1;
